...
w_row = 8
w_column = 2
VoltageChange_button = tk.Button(setting_data_region, text="開關1開啟", bg="#00AAFF", command=VoltageChange_on)
VoltageChange_button.grid(column=w_column, row=w_row)
w_row = 9
w_column = 2
VoltageChange_button = tk.Button(setting_data_region, text="開關1關閉", bg="#007700", command=VoltageChange_off)
VoltageChange_button.grid(column=w_column, row=w_row)
setting_data_region.pack(side='top', anchor='w')
...
w_row = 8
w_column = 3
HeatingOn_button = tk.Button(setting_data_region, text="開關2開啟", bg="#00AAFF", command=Heating_on)
HeatingOn_button.grid(column=w_column, row=w_row)
w_row = 9
w_column = 3
HeatingOff_button = tk.Button(setting_data_region, text="開關2關閉", bg="#007700", command=Heating_off)
...
w_row = 8
w_column = 4
HighTempMode1_button = tk.Button(setting_data_region, text="高溫1開啟", bg="#00AAFF", command=HighTempMode1)
HighTempMode1_button.grid(column=w_column, row=w_row)
# 高溫2-模式切換按鈕
w_row = 8
w_column = 5
HighTempMode2_button = tk.Button(setting_data_region, text="高溫2開啟", bg="#00AAFF", command=HighTempMode2)
HighTempMode2_button.grid(column=w_column, row=w_row)
# 一般模式
w_row = 9
w_column = 4
GeneralMode_button = tk.Button(setting_data_region, text="一般模式", bg="#007700", command=GeneralMode)
GeneralMode_button.grid(column=w_column, row=w_row)
setting_data_region.pack(side='top', anchor='w')
